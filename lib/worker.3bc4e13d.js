...
parcelRequire = (function (modules, cache, entry, globalName) {
  ...
  return newRequire;
})({"OK3c":[function(require,module,exports) {
'use strict'
...
},{}],"bgWq":[function(require,module,exports) {
...
},{}],"IxSC":[function(require,module,exports) {
...
},{}],"rtDF":[function(require,module,exports) {
...
},{"base64-js":"OK3c","ieee754":"bgWq","isarray":"IxSC","buffer":"rtDF"}],"ddw3":[function(require,module,exports) {
var global = arguments[3];
...
},{"buffer":"rtDF"}],"Ab0p":[function(require,module,exports) {
"use strict";
...
},{}],"Eyqo":[function(require,module,exports) {
"use strict";
...
var _InputPreprocessor = _interopRequireDefault(require("./InputPreprocessor.js"));

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

// asdsad
const cleanupRegexes = [[new RegExp("[àáâãäå]", 'g'), "a"], [new RegExp("æ", 'g'), "ae"], [new RegExp("ç", 'g'), "c"], [new RegExp("[èéêë]", 'g'), "e"], [new RegExp("[ìíîï]", 'g'), "i"], [new RegExp("ñ", 'g'), "n"], [new RegExp("[òóôõö]", 'g'), "o"], [new RegExp("œ", 'g'), "oe"], [new RegExp("[ùúûü]", 'g'), "u"], [new RegExp("[ýÿ]", 'g'), "y"]];
...
class RemoveSpecialChars extends _InputPreprocessor.default {
  constructor(config) {
...
},{"./InputPreprocessor.js":"Ab0p"}],"032z":[function(require,module,exports) {
"use strict";
...
var _InputPreprocessor = _interopRequireDefault(require("./InputPreprocessor"));

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

// import _ from "../../lib/lodash.js"
const words = ["algún", "alguna", "algunas", "alguno", "algunos", "ambos", "ampleamos", "ante", "antes", "aquel", "aquellas", "aquellos", "aqui", "arriba", "atras", "bajo", "bastante", "bien", "cada", "cierta", "ciertas", "cierto", "ciertos", "como", "con", "conseguimos", "conseguir", "consigo", "consigue", "consiguen", "consigues", "cual", "cuando", "dentro", "desde", "donde", "dos", "de", "del", "el", "ellas", "ellos", "empleais", "emplean", "emplear", "empleas", "empleo", "en", "encima", "entonces", "entre", "era", "eramos", "eran", "eras", "eres", "es", "esta", "estaba", "estado", "estais", "estamos", "estan", "estoy", "fin", "fue", "fueron", "fui", "fuimos", "gueno", "ha", "hace", "haceis", "hacemos", "hacen", "hacer", "haces", "hago", "incluso", "intenta", "intentais", "intentamos", "intentan", "intentar", "intentas", "intento", "ir", "la", "largo", "las", "lo", "los", "mientras", "mio", "modo", "muchos", "muy", "nos", "nosotros", "otro", "para", "pero", "podeis", "podemos", "poder", "podria", "podriais", "podriamos", "podrian", "podrias", "por", "por qué", "porque", "primero", "puede", "pueden", "puedo", "quien", "sabe", "sabeis", "sabemos", "saben", "saber", "sabes", "ser", "si", "siendo", "sin", "sobre", "sois", "solamente", "solo", "somos", "soy", "su", "sus", "también", "teneis", "tenemos", "tener", "tengo", "tiempo", "tiene", "tienen", "todo", "trabaja", "trabajais", "trabajamos", "trabajan", "trabajar", "trabajas", "trabajo", "tras", "tuyo", "ultimo", "un", "una", "unas", "uno", "unos", "usa", "usais", "usamos", "usan", "usar", "usas", "uso", "va", "vais", "valor", "vamos", "van", "vaya", "verdad", "verdadera", "verdadero", "vosotras", "vosotros", "voy", "yo"];
const wordIndex = {};
words.forEach(w => wordIndex[w] = true);

class RemoveStopWords extends _InputPreprocessor.default {
  constructor(config) {
    super("Remove stopwords", config);
  }
...
},{"./InputPreprocessor":"Ab0p"}],"vtSb":[function(require,module,exports) {
"use strict";
...
var _lodash = _interopRequireDefault(require("../lib/lodash.js"));

var _RemoveSpecialChars = _interopRequireDefault(require("./preprocessors/RemoveSpecialChars"));

var _RemoveStopWords = _interopRequireDefault(require("../core/preprocessors/RemoveStopWords"));
...
class CoreWorker {
  constructor(loggerCbk, progressCbk) {
    ...
    this.preprocessorsClasses = {
      RemoveSpecialChars: _RemoveSpecialChars.default,
      RemoveStopWords: _RemoveStopWords.default
    };
  }
    ...
    const resume = (START, query) => {
      ...
      for (i = START; i < filteredItems.length; i++) {
        ...
        while (execRes = re.exec(itemText)) {
          ...
          if (execRes.index === lastIndex) break;
      ...
      if (i < filteredItems.length) {
        ...
        topMatches = _lodash.default.sortBy(_lodash.default.toPairs(topMatches), "1").reverse();
        searching = false;
        lastSearchTime = new Date().valueOf() - startTime; // TODO: Needed for download results. Stop doing this EVERY TIME
  ...
  preprocessData(data) {
    ...
    _lodash.default.each(data, (doc, index) => {
      try {
        let processedItem = doc;

        if (!_lodash.default.isString(processedItem)) {
          if (_lodash.default.isObject(processedItem)) {
  ...
  applyDrilldownFilters() {
    ...
    filteredItems = []; // REset affected items count

    for (let step of this.drilldownActions) {
      step.affectedCount = 0;
    }

    _lodash.default.each(items, (doc, index) => {
      if (new Date() - lastStatus > 100) {
  ...
  setPreprocessors(preprocessorsConfigs) {
    this.preprocessors = _lodash.default.map(_lodash.default.filter(preprocessorsConfigs, c => c.enabled), config => {
  ...
  drilldownAction(action, ...params) {
    if (action === 'addFilter' || action === 'addExclusion') {
      ...
      let step = _lodash.default.find(this.drilldownActions, {
        id: filterId
      });
      ...
      _lodash.default.remove(this.drilldownActions, s => s.id === filterId);
    }
...
},{"../lib/lodash.js":"ddw3","./preprocessors/RemoveSpecialChars":"Eyqo","../core/preprocessors/RemoveStopWords":"032z"}],"iltZ":[function(require,module,exports) {
"use strict";

var _CoreWorker = _interopRequireDefault(require("./core/CoreWorker"));

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

const worker = new _CoreWorker.default((...msg) => {
  console.log(msg);
}, (msg, payload) => {
  self.postMessage({
    msg,
...
},{"./core/CoreWorker":"vtSb"}]},{},["iltZ"], null)
//# sourceMappingURL=worker.3bc4e13d.map