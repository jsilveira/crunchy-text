...
},{"./cjs/react.production.min.js":"awqi"}],"Gvp3":[function(require,module,exports) {
'use strict'
...
},{"base64-js":"Gvp3","ieee754":"jJYq","isarray":"pRlI","buffer":"wYDm"}],"B1iE":[function(require,module,exports) {
var global = arguments[3];
...
},{"buffer":"wYDm"}],"UQex":[function(require,module,exports) {
"use strict";
...
},{"fbjs/lib/emptyFunction":"UQex","fbjs/lib/invariant":"wRUG","./lib/ReactPropTypesSecret":"Asjh"}],"D9Od":[function(require,module,exports) {
/**
 * Copyright (c) 2013-present, Facebook, Inc.
 *
 * This source code is licensed under the MIT license found in the
...
},{"./factoryWithThrowingShims":"wVGV"}],"CtUq":[function(require,module,exports) {
/**
 * Copyright (c) 2013-present, Facebook, Inc.
 *
 * This source code is licensed under the MIT license found in the
...
},{"react":"n8MK","./factory":"mdfe"}],"JiK6":[function(require,module,exports) {
var define;
...
},{"react":"n8MK","prop-types":"D9Od","create-react-class":"IAnx"}],"HNps":[function(require,module,exports) {
"use strict";
...
},{"react":"n8MK"}],"qbmA":[function(require,module,exports) {
module.exports = {
  "file-drop": "_file-drop_391b9",
  "file-drop-target": "_file-drop-target_391b9",
  "file-drop-dragging-over-frame": "_file-drop-dragging-over-frame_391b9",
  "file-drop-dragging-over-target": "_file-drop-dragging-over-target_391b9"
};
},{}],"nLB2":[function(require,module,exports) {
"use strict";
...
class InputBar extends _react.Component {
  constructor(props) {
    super(props); // this.state = {currentInput: this.props.value};
...
},{"react":"n8MK","react-file-drop":"JiK6","./PreprocessorsSelector":"HNps","../../../public/stylesheets/file-drop.css":"qbmA"}],"SdKF":[function(require,module,exports) {
"use strict";
...
},{"react":"n8MK"}],"Sedq":[function(require,module,exports) {
"use strict";
...
module.exports = {
  "ResultsTable": "_ResultsTable_e7a2d",
  "withLongWords": "_withLongWords_e7a2d",
  "TopMatchesTable": "_TopMatchesTable_e7a2d",
  "markj": "_markj_e7a2d"
};
},{}],"zBPI":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.RegexSearchResult = void 0;
...
class RegexSearchResult extends _react.default.PureComponent {
  render() {
    const parts = [];
    const {
      item,
...
exports.RegexSearchResult = RegexSearchResult;
},{"react":"n8MK","../../../public/stylesheets/search-results.less":"fpv7"}],"im0K":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.TopMatches = void 0;
  ...
  render() {
    ...
    items.slice(0, 100).forEach(([uniqueMatch, count], i) => {
      rows.push(_react.default.createElement("tr", {
        ...
        className: "text-info text-right pr-3"
      }, " ", count.toString(), " "), _react.default.createElement("td", null, uniqueMatch.toString(), " "), _react.default.createElement("td", {
        className: 'small text-secondary text-right pl-2'
...
exports.TopMatches = TopMatches;
},{"react":"n8MK","../../../public/stylesheets/search-results.less":"fpv7"}],"UscS":[function(require,module,exports) {
"use strict";
...
var _RegexSearchResult = require("./RegexSearchResult");

var _TopMatches = require("./TopMatches");
...
function getHtmlTableResultRow(collection) {
  ...
  for (let i = 0; i < collection.length; i++) {
    ...
    let cssClass = hasLongWord ? _searchResults.default.withLongWords : ''; // cols.push(<td key={i} className={cssClass}>{col}</td>);

    cols.push(`<td class="${cssClass}">${col}</td>`);
  }

  cols = cols.join(''); // return <tr className={""}>{cols}</tr>;
...
class SearchResults extends _react.Component {
  ...
  buildResultsTable(searchRes, maxRows) {
    ...
    items.slice(0, maxRows).forEach((res, i) => {
      results.push(_react.default.createElement("tr", {
        ...
        className: ""
      }, _react.default.createElement("td", null, _react.default.createElement(_RegexSearchResult.RegexSearchResult, {
        result: res
      }))));
    });
    ...
    }, _react.default.createElement("tbody", null, results));
  }
  ...
  buildTabularResultsTable(searchRes, maxRows) {
    ...
    if (resultsFormat.type === 'tabularText' && resultsFormat.columns) {
      results.push(`<tr>${_lodash.default.map(resultsFormat.columns, (col, j) => `<th>${col}</th>`).join('')}</tr>`);
    }
    ...
    items.slice(0, maxRows).forEach((res, i) => {
      ...
      if (_lodash.default.isString(cols)) {
        for (let j = matches.length - 1; j >= 0; j--) {
          const m = matches[j];

          if (m[0]) {
            cols = cols.slice(0, m.index) + `<mark class="${_searchResults.default.markj}">${m[0]}</mark>` + cols.slice(m.index + m[0].length);
          }
        }
  ...
  buildResults(searchRes, maxRows) {
    ...
    if (items.length > maxRows) {
      ...
      pagination = _react.default.createElement("div", {
    ...
    return _react.default.createElement("div", null, table, pagination);
  }
  ...
  render() {
    ...
    if (searchRes.extras) {
      ...
      if (top) {
        if (_lodash.default.keys(topMatches).length > 1) {
          extras.push(_react.default.createElement("ul", {
            key: 'groups',
            className: 'nav nav-tabs mb-2'
          }, _lodash.default.map(topMatches, (tops, groupNumber) => _react.default.createElement("li", {
            key: groupNumber,
            className: 'nav-item'
        ...
        extras.push(_react.default.createElement(_TopMatches.TopMatches, {
          key: 'top',
    ...
    let result = _react.default.createElement("div", {
      ...
      className: "material-icons align-middle"
    }, "file_download")))), table), _react.default.createElement("div", {
...
},{"react":"n8MK","../../utils/downloadFile":"Sedq","../../../public/stylesheets/search-results.less":"fpv7","lodash":"B1iE","./RegexSearchResult":"zBPI","./TopMatches":"im0K"}],"FUOi":[function(require,module,exports) {
"use strict";
...
class CoreWorkerProxy {
  constructor() {
    ...
    this.worker = new Worker("worker.754bc941.js");
...
},{"./..\\worker.js":[["worker.754bc941.js","iltZ"],"worker.754bc941.js.map","iltZ"]}],"wkJS":[function(require,module,exports) {
"use strict";
...
},{"react":"n8MK"}],"GoAA":[function(require,module,exports) {
...
var _InputBar = _interopRequireDefault(require("./input-bar/InputBar.js"));

var _SearchBar = _interopRequireDefault(require("./search-bar/SearchBar.js"));

var _SearchResults = _interopRequireDefault(require("./search-results/SearchResults.js"));

var _CoreWorkerProxy = _interopRequireDefault(require("../core/CoreWorkerProxy"));

var _DrilldownFiltersBar = _interopRequireDefault(require("./search-bar/DrilldownFiltersBar"));
...
const sampleData = require('../../public/samples/sample-data.json'); // const sampleTabularData = [
//   "col A\tcolB\tcolC",
...
class CrunchyText extends _react.Component {
  constructor(props) {
    ...
    this.coreWorker.loadDataWithFormat({
      dataFormat: {
        type: 'text'
      },
      data: sampleData
    ...
    this.coreWorker.onFileProgress(({
      progress
    }) => {
  ...
  render() {
    ...
    return _react.default.createElement("div", null, _react.default.createElement(_InputBar.default, {
      ...
      drilldownSteps: this.state.drillDownSteps,
      onDrilldownAction: this.drilldownAction.bind(this)
...
},{"react":"n8MK","lodash":"B1iE","./input-bar/InputBar.js":"nLB2","./search-bar/SearchBar.js":"SdKF","./search-results/SearchResults.js":"UscS","../core/CoreWorkerProxy":"FUOi","./search-bar/DrilldownFiltersBar":"wkJS","../utils/downloadFile":"Sedq","../../public/samples/sample-data.json":"GoAA"}],"Focm":[function(require,module,exports) {
"use strict";
...
var _SearchBar = _interopRequireDefault(require("./ui/search-bar/SearchBar"));

var _SearchResults = _interopRequireDefault(require("./ui/search-results/SearchResults"));

var _DrilldownFiltersBar = _interopRequireDefault(require("./ui/search-bar/DrilldownFiltersBar"));

var _InputBar = _interopRequireDefault(require("./ui/input-bar/InputBar"));

var _CoreWorkerProxy = _interopRequireDefault(require("./core/CoreWorkerProxy"));

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }
},{"./ui/CrunchyText":"NQAW","./ui/search-bar/SearchBar":"SdKF","./ui/search-results/SearchResults":"UscS","./ui/search-bar/DrilldownFiltersBar":"wkJS","./ui/input-bar/InputBar":"nLB2","./core/CoreWorkerProxy":"FUOi"}]},{},["Focm"], null)
