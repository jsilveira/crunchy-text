...
},{"base64-js":29,"ieee754":31,"isarray":30,"buffer":26}],19:[function(require,module,exports) {
var global = (1,eval)("this");
...
},{"buffer":26}],27:[function(require,module,exports) {
"use strict";
...
var _InputPreprocessor = require("./InputPreprocessor.js");

var _InputPreprocessor2 = _interopRequireDefault(_InputPreprocessor);

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

const cleanupRegexes = [[new RegExp("[àáâãäå]", 'g'), "a"], [new RegExp("æ", 'g'), "ae"], [new RegExp("ç", 'g'), "c"], [new RegExp("[èéêë]", 'g'), "e"], [new RegExp("[ìíîï]", 'g'), "i"], [new RegExp("ñ", 'g'), "n"], [new RegExp("[òóôõö]", 'g'), "o"], [new RegExp("œ", 'g'), "oe"], [new RegExp("[ùúûü]", 'g'), "u"], [new RegExp("[ýÿ]", 'g'), "y"]]; // asdsad
...
class RemoveSpecialChars extends _InputPreprocessor2.default {
  constructor(config) {
...
},{"./InputPreprocessor.js":27}],21:[function(require,module,exports) {
"use strict";
...
},{"./InputPreprocessor":27}],16:[function(require,module,exports) {
"use strict";
...
var _lodash = require("../lib/lodash.js");

var _lodash2 = _interopRequireDefault(_lodash);

var _RemoveSpecialChars = require("./preprocessors/RemoveSpecialChars");

var _RemoveSpecialChars2 = _interopRequireDefault(_RemoveSpecialChars);

var _RemoveStopWords = require("../core/preprocessors/RemoveStopWords");

var _RemoveStopWords2 = _interopRequireDefault(_RemoveStopWords);
...
class CoreWorker {
  ...
  preprocessData(data) {
    ...
    items = [];
    _lodash2.default.each(data, (doc, index) => {
      try {
        let processedItem = doc;
        if (!_lodash2.default.isString(processedItem)) {
          if (_lodash2.default.isObject(processedItem)) {
  ...
  setPreprocessors(preprocessorsConfigs) {
    this.preprocessors = _lodash2.default.map(_lodash2.default.filter(preprocessorsConfigs, c => c.enabled), config => {
...
},{"../lib/lodash.js":19,"./preprocessors/RemoveSpecialChars":20,"../core/preprocessors/RemoveStopWords":21}],14:[function(require,module,exports) {
"use strict";

var _CoreWorker = require("./core/CoreWorker");

var _CoreWorker2 = _interopRequireDefault(_CoreWorker);

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

const worker = new _CoreWorker2.default((...msg) => {
  console.log(msg);
}, (msg, payload) => {
